...
class LoginOld : AppCompatActivity() {
 ...
 /*   private fun loginOld(phone: String, password: String){
        try {
            ...
            binding.loader.progressBar.visibility = View.GONE
            binding.btnLogin.isClickable = true
            Toast.makeText(applicationContext,"Internet Problem",Toast.LENGTH_SHORT).show()
        }
